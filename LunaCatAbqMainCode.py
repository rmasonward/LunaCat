...
def evalModel(BASE_WIDTH, BASE_HEIGHT, THICKNESS, ARM_LENGTH, TAPER_RATIO, WALL_LENGTH, AXLE_LENGTH, MATERIAL_TYPE, ToptThickness, L1_percent,CLEVIS_EDGE_THICK,jobNumber):
    ...
    p = mdb.models[ModelName].Part(name='Side_wall_1', dimensionality=THREE_D, 
        type=DEFORMABLE_BODY)
    p = mdb.models[ModelName].parts['Side_wall_1']
    ...
    mdb.models[ModelName].sketches.changeKey(fromName='__profile__', 
        toName='__save__')
    s = mdb.models[ModelName].ConstrainedSketch(name='__profile__', sheetSize=10.0)
    g, v, d, c = s.geometry, s.vertices, s.dimensions, s.constraints
    s.setPrimaryObject(option=STANDALONE)
    s.retrieveSketch(sketch=mdb.models[ModelName].sketches['__save__'])
    ...
    p = mdb.models[ModelName].Part(name='SquareCutOut', dimensionality=THREE_D, 
        type=DEFORMABLE_BODY)
    p = mdb.models[ModelName].parts['SquareCutOut']
    ...
    s.setPrimaryObject(option=STANDALONE)
    s.retrieveSketch(sketch=mdb.models[ModelName].sketches['__save__'])
    del mdb.models[ModelName].sketches['__save__']
    s.CircleByCenterPerimeter(center=(CLEVIS_DIST, 0.0), point1=(CLEVIS_DIST+CLEVIS_RAD, 
        0.0))
    p = mdb.models[ModelName].Part(name='XbeamCutOut', dimensionality=THREE_D, 
        type=DEFORMABLE_BODY)
    p = mdb.models[ModelName].parts['XbeamCutOut']
    p.BaseSolidExtrude(sketch=s, depth=WALL_THICKNESS)
    s.unsetPrimaryObject()
    p = mdb.models[ModelName].parts['XbeamCutOut']
    ...
    p = mdb.models[ModelName].Part(name='TopOptCut', dimensionality=THREE_D, 
        type=DEFORMABLE_BODY)
    p = mdb.models[ModelName].parts['TopOptCut']
    p.BaseSolidExtrude(sketch=s, depth=WALL_THICKNESS)
    s.unsetPrimaryObject()
    p = mdb.models[ModelName].parts['TopOptCut']
    ...
    ## Cleaning up model
    p1 = mdb.models[ModelName].parts['XbeamCutOut']
    session.viewports['Viewport: 1'].setValues(displayedObject=p1)
    del mdb.models[ModelName].parts['XbeamCutOut']
    p = mdb.models[ModelName].parts['Side_wall_1']
    session.viewports['Viewport: 1'].setValues(displayedObject=p)
    p1 = mdb.models[ModelName].parts['SquareCutOut']
    session.viewports['Viewport: 1'].setValues(displayedObject=p1)
    del mdb.models[ModelName].parts['SquareCutOut']
    p = mdb.models[ModelName].parts['Side_wall_1']
    session.viewports['Viewport: 1'].setValues(displayedObject=p)
    del mdb.models[ModelName].parts['Side_wall_1']
    p = mdb.models[ModelName].parts['TopOptCut']
    session.viewports['Viewport: 1'].setValues(displayedObject=p)
    mdb.models[ModelName].parts.changeKey(fromName='TopOptCut', 
        toName='Side_wall_1')
    ...
    p = mdb.models[ModelName].Part(name=OUTER_ARM_NAME, dimensionality=THREE_D, 
        type=DEFORMABLE_BODY)
    p = mdb.models[ModelName].parts[OUTER_ARM_NAME]
    ...
    p = mdb.models[ModelName].Part(name=INNER_ARM_NAME, dimensionality=THREE_D, 
        type=DEFORMABLE_BODY)
    p = mdb.models[ModelName].parts[INNER_ARM_NAME]
    ...
    a.InstanceFromBooleanCut(name=ARM_NAME, 
        instanceToBeCut=mdb.models[ModelName].rootAssembly.instances[OUTER_ARM_INST_NAME], 
        cuttingInstances=(a.instances[INNER_ARM_INST_NAME], ), 
        originalInstances=SUPPRESS)

    #make the "spoon" section
    p = mdb.models[ModelName].parts[ARM_NAME]
    f, e = p.faces, p.edges
    ...
    # t = p.MakeSketchTransform(sketchPlane=f.findAt(coordinates=(ARM_LENGTH+BASE_LENGTH-SPOON_LENGTH/2, 0.0, 
        ...
        # BASE_WIDTH))
    # s = mdb.models[ModelName].ConstrainedSketch(name='__profile__', sheetSize=11.2, 
    ...
    # #Deleting flanges
    # p = mdb.models[ModelName].parts['ARM']
    ...
    p = mdb.models[ModelName].Part(name='Payload', dimensionality=THREE_D, 
        type=DEFORMABLE_BODY)
    p = mdb.models[ModelName].parts['Payload']
    ...
    p = mdb.models[ModelName].Part(name='Connector_beam', dimensionality=THREE_D, 
        type=DEFORMABLE_BODY)
    p = mdb.models[ModelName].parts['Connector_beam']
    ...
    s = mdb.models[ModelName].ConstrainedSketch(name='__profile__', sheetSize=4.46, 
    ...
    p = mdb.models[ModelName].Part(name=XBEAM_NAME, dimensionality=THREE_D, 
        type=DEFORMABLE_BODY)
    p = mdb.models[ModelName].parts[XBEAM_NAME]
    ...
    s = mdb.models[ModelName].ConstrainedSketch(name='__profile__', sheetSize=1.31, 
    ...
    mdb.models[ModelName].Material(name=material_name)
    mdb.models[ModelName].materials[material_name].Density(table=((density, ), ))
    mdb.models[ModelName].materials[material_name].Elastic(table=((youngs, 
        poisson), ))

    # #Creating Graphite
    # mdb.models[ModelName].Material(name='Graphite Epoxy AS/3501')
    # mdb.models[ModelName].materials['Graphite Epoxy AS/3501'].Elastic(type=ENGINEERING_CONSTANTS, 
    ...
    # mdb.models[ModelName].materials['Graphite Epoxy AS/3501'].Density(table=((
        # 1610.0, ), ))

        
    #Creating Payload material
    mdb.models[ModelName].Material(name='MoonRock')
    mdb.models[ModelName].materials['MoonRock'].Density(table=((PAY_DESNITY, ), ))
    mdb.models[ModelName].materials['MoonRock'].Elastic(table=((10000000000.0, 
        0.3), ))
    ...
    #Creating Section 3
    mdb.models[ModelName].HomogeneousSolidSection(name='Section-3', 
    ...
    p = mdb.models[ModelName].parts['CROSSMEMBER']
    c = p.cells
    cells = c.findAt(((0.0, 0.0, 0.0), ))
    region = p.Set(cells=cells, name='Set-1')
    p = mdb.models[ModelName].parts['CROSSMEMBER']
    ...
    # compositeLayup = mdb.models[ModelName].parts['ARM'].CompositeLayup(
    ...
    # mdb.models[ModelName].parts['Side_wall_1'].features.changeKey(fromName='RP', 
    ...
    p1 = mdb.models[ModelName].parts['Side_wall_1']
    session.viewports['Viewport: 1'].setValues(displayedObject=p1)
    p = mdb.models[ModelName].Part(name='Side_wall_2', 
        objectToCopy=mdb.models[ModelName].parts['Side_wall_1'])
    p = mdb.models[ModelName].parts['Side_wall_2']
    ...
    spoonCoords = mdb.models[ModelName].rootAssembly.instances['Payload-1'].sets['PAY_PULL_POINT'].vertices[0].pointOn[0]
    clevisAxleCoords = mdb.models[ModelName].rootAssembly.instances['Side_wall_1-1'].datums[4].pointOn #NOTE!!! add a dynamic refence to the datum index (like I did for the arm)

    print(spoonCoords)
    print(clevisAxleCoords)

    # spoonCoords = mdb.models[ModelName].rootAssembly.instances['ARM-1'].sets['SPOON_PULL_POINT'].nodes[0].coordinates
    ...
    pullPointCoords = mdb.models[ModelName].rootAssembly.instances['CROSSMEMBER-1'].sets['XBEAM_PULL_POINT'].vertices[0].pointOn[0]
    ...
    p = mdb.models[ModelName].Part(name='WIRE_BOI', dimensionality=THREE_D, 
        type=DEFORMABLE_BODY)
    p = mdb.models[ModelName].parts['WIRE_BOI']
    p.BaseWire(sketch=s)
    s.unsetPrimaryObject()
    p = mdb.models[ModelName].parts['WIRE_BOI']
    session.viewports['Viewport: 1'].setValues(displayedObject=p)
    ...
    mdb.models[ModelName].Material(name='WireMatl')
    mdb.models[ModelName].materials['WireMatl'].Expansion(table=((-CTE_VAL, ), ))
    mdb.models[ModelName].materials['WireMatl'].Density(table=((9000.0, ), ))
    mdb.models[ModelName].materials['WireMatl'].Elastic(table=((10000000000000000.0, 
        0.3), ))

    mdb.models[ModelName].HomogeneousSolidSection(name='WireSection', 
        material='WireMatl', thickness=None)
    del mdb.models[ModelName].sections['WireSection']
    mdb.models[ModelName].CircularProfile(name='WireCircProfile', r=DRAW_WIRE_RADIUS)
    mdb.models[ModelName].BeamSection(name='WireSection', 
    ...
    region = mdb.models[ModelName].rootAssembly.instances['WIRE_BOI-1'].sets['All_Wire_Edges']
    mdb.models[ModelName].Temperature(name='WireTemp', createStepName='Initial', 
    ...
    # mdb.models[ModelName].ImplicitDynamicsStep(name='Loading', previous='Initial', 
    ...
    # mdb.models[ModelName].steps['Loading'].setValues(timePeriod=1.0, maxNumInc=500, 
    ...
    mdb.models[ModelName].steps['Loading'].setValues(timePeriod=1.0, maxNumInc=500, minInc=5e-05)
        
    # Defining Launch step
    mdb.models[ModelName].ImplicitDynamicsStep(name='Launch', previous='Loading', 
        timePeriod=0.01, application=TRANSIENT_FIDELITY, initialInc=0.01, 
        minInc=2e-07, nohaf=OFF, initialConditions=ON)
    mdb.models[ModelName].steps['Launch'].setValues(maxNumInc=500)
    
    # Defining Buckling step
    mdb.models[ModelName].BuckleStep(name='BuckleCheck', previous='Loading', numEigen=1, 
        eigensolver=LANCZOS, minEigen=None, blockSize=DEFAULT, maxBlocks=DEFAULT)
    
    # Defining FollowThru step
    mdb.models[ModelName].ImplicitDynamicsStep(name='FollowThru', previous='Launch', 
        timePeriod=0.15, application=TRANSIENT_FIDELITY, initialInc=0.015, 
        minInc=2e-05, nohaf=OFF, initialConditions=ON)
    mdb.models[ModelName].steps['FollowThru'].setValues(maxNumInc=300) ####JOB BROKE WITH ONLY 100 INCS LAST TIME   
       
    #update save increments for ODB output
    mdb.models[ModelName].fieldOutputRequests['F-Output-1'].setValuesInStep(
    ...
    mdb.models[ModelName].SmoothStepAmplitude(name='Amp-1', timeSpan=STEP, data=((
        0.0, 0.0), (1.0, 1.0)))
    mdb.models[ModelName].predefinedFields['WireTemp'].setValuesInStep(
    ...
    mdb.models[ModelName].Tie(name='Arm__Beam', master=region1, slave=region2, 
    ...
    mdb.models[ModelName].Tie(name='Beam__Sidewall1', master=region1, slave=region2, 
        positionToleranceMethod=COMPUTED, adjust=ON, tieRotations=ON, thickness=ON)
    region1=a.instances['Connector_beam-1'].surfaces['RightSide']
    a = mdb.models[ModelName].rootAssembly
    region2=a.instances['Side_wall_2-1'].surfaces['SquareNotch']
    mdb.models[ModelName].Tie(name='Beam__Sidewall2', master=region1, 
    ...
    mdb.models[ModelName].Tie(name='Cross__Sidewall1', master=region1, 
        slave=region2, positionToleranceMethod=COMPUTED, adjust=ON, 
        tieRotations=ON, thickness=ON)
    region1=a.instances['CROSSMEMBER-1'].surfaces['LeftSide']
    region2=a.instances['Side_wall_2-1'].surfaces['CircularNotch']
    mdb.models[ModelName].Tie(name='Cross__Sidewall2', master=region1, 
        slave=region2, positionToleranceMethod=COMPUTED, adjust=ON, 
        tieRotations=ON, thickness=ON)
    ...
    mdb.models[ModelName].Tie(name='Lower_Wire_Tie', master=region1, slave=region2, 
        positionToleranceMethod=COMPUTED, adjust=ON, tieRotations=ON, thickness=ON)
        
    # #Tie Wire to the Spoon Back
    # region1=a.instances['ARM-1'].surfaces['SPOON_PULL_SURF']
    # region2=a.sets['WireEnd_Arm']
    # mdb.models[ModelName].Tie(name='Upper_Wire_Tie', master=region1, slave=region2, 
        # positionToleranceMethod=COMPUTED, adjust=ON, tieRotations=ON, thickness=ON)
    ...
    #Wire deletion step
    a = mdb.models[ModelName].rootAssembly
    edges1 = region = mdb.models[ModelName].rootAssembly.instances['WIRE_BOI-1'].sets['All_Wire_Edges']
    mdb.models[ModelName].ModelChange(name='WireDeletion', createStepName='Launch', 
        region=region, activeInStep=False, includeStrain=False)
    #: The interaction "Int-2" has been created.
    # mdb.models[ModelName].interactions['Int-1'].reset('Launch')

    #ADD CONTACT
    #define contact property
    mdb.models[ModelName].ContactProperty('PayloadRoughContactProp')
    mdb.models[ModelName].interactionProperties['PayloadRoughContactProp'].TangentialBehavior(
        formulation=ROUGH)
    mdb.models[ModelName].interactionProperties['PayloadRoughContactProp'].NormalBehavior(
    ...
    regionDef=mdb.models[ModelName].rootAssembly.allInstances['Payload-1'].sets['BOTTOM_PAYLOAD']
    mdb.models[ModelName].SurfaceToSurfaceContactStd(name='ROUGH_CONTACT', 
    ...
    #creating gravity
    mdb.models[ModelName].Gravity(name='Load-1', createStepName='Loading', 
        comp2=-1.62, distributionType=UNIFORM, field='')
        
    #BuckleCheck Dummy Load
    region = a.instances['Payload-1'].sets['PAY_PULL_POINT']
    mdb.models[ModelName].ConcentratedForce(name='BuckleDummy', 
    ...
    mdb.models[ModelName].EncastreBC(name='Sidewall1Clamp', 
        createStepName='Initial', region=region, localCsys=None)
    region = a.instances['Side_wall_2-1'].sets['Bottom']
    mdb.models[ModelName].EncastreBC(name='Sidewall2Clamp', 
        createStepName='Initial', region=region, localCsys=None)

    #prevent wire from rotating about its axis due to roundoff error.
    region = mdb.models[ModelName].rootAssembly.instances['WIRE_BOI-1'].sets['All_Wire_Edges']
    mdb.models[ModelName].DisplacementBC(name='WireNoVertRotation', createStepName='Initial', 
    ...
    # mdb.models[ModelName].DisplacementBC(name='PayloadNoZSlide', 
    ...
    pickedRegions =(cells, )
    p.setElementType(regions=pickedRegions, elemTypes=(elemType1,elemType3))
    ...
    session.viewports['Viewport: 1'].assemblyDisplay.geometryOptions.setValues(
        datumPoints=OFF, datumAxes=OFF, datumCoordSystems=OFF)
    ...
    session.viewports['Viewport: 1'].view.setValues(nearPlane=2.51365, 
        farPlane=11.3484, cameraPosition=(-1.43814, 3.11208, 8.23335), 
        cameraUpVector=(0.305995, 0.87474, -0.375762))
    session.viewports['Viewport: 1'].view.setValues(width=13.0446, height=5.00605, 
        cameraPosition=(-1.55781, 3.02518, 8.15646), cameraTarget=(2.70012, 
        1.88139, 2.82202))
    session.printOptions.setValues(vpDecorations=OFF)
    
    #Build image filepath
    currentPath = os.getcwd()
    outPath = os.path.join(currentPath,"Model_Images",JobName)
    print(outPath)
    ...
    # return 0.0,0.0,1.0,0.0,mass 

if __name__ == "__main__":
    #BASE_WIDTH, BASE_HEIGHT, THICKNESS, ARM_LENGTH, TAPER_RATIO, WALL_LENGTH, AXLE_LENGTH, MATERIAL_TYPE, ToptThickness, L1_percent, CLEVIS_EDGE_THICK
    print(evalModel(0.4, 0.3, 0.0225, 5.0, 1.0, 4.0, 4.0, 3, 0.2, 20.0, 0.1, 1))
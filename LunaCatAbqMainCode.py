...
def evalModel(BASE_WIDTH, BASE_HEIGHT, THICKNESS, ARM_LENGTH, TAPER_RATIO, WALL_LENGTH, AXLE_LENGTH, MATERIAL_TYPE, ToptThickness, L1_percent, L2_percent, CLEVIS_EDGE_THICK, XBEAM_EDGE_THICK):
    ...
    a.FaceToFace(movablePlane=d11[5], fixedPlane=d12[24], flip=OFF, clearance=0.0)
    d11 = a.instances['Payload-1'].datums
    d12 = a.instances['ARM-1'].datums
    ...
    mdb.models['Model-1'].ContactProperty('PayloadSlideyContactProp')
    mdb.models['Model-1'].interactionProperties['PayloadSlideyContactProp'].TangentialBehavior(
        formulation=FRICTIONLESS)
    mdb.models['Model-1'].interactionProperties['PayloadSlideyContactProp'].NormalBehavior(
        pressureOverclosure=HARD, allowSeparation=ON, 
        constraintEnforcementMethod=DEFAULT) 
    
    mdb.models['Model-1'].ContactProperty('StickyContactProp')
    mdb.models['Model-1'].interactionProperties['StickyContactProp'].TangentialBehavior(
        formulation=FRICTIONLESS)
    mdb.models['Model-1'].interactionProperties['StickyContactProp'].NormalBehavior(
    ...
    s = p.faces
    side1Faces = s.findAt(((PAY_LENGTH/4, 0.0, PAY_WIDTH/4), ), ((3*PAY_LENGTH/4, 0.0, PAY_WIDTH/4), ), (
        (PAY_LENGTH/4, 0.0, 3*PAY_WIDTH/4), ), ((3*PAY_LENGTH/4, 0.0, 3*PAY_WIDTH/4), ))
    p.Surface(side1Faces=side1Faces, name='PayloadBottomCenter')
    ...
    #Tie Wire to the Payload Back
    region1=a.instances['Payload-1'].surfaces['PayloadBottomCenter']
    region2=a.sets['WireEnd_Arm']
    mdb.models['Model-1'].Tie(name='BottomPayloadTie', master=region1, 
        slave=region2, positionToleranceMethod=COMPUTED, adjust=ON, 
        tieRotations=ON, thickness=ON)
    ...
    #bottom surfaces
    region1=a.instances['ARM-1'].surfaces['SPOON_BACK']
    region2=a.instances['Payload-1'].surfaces['BackBottomPayloadSticky1']
    mdb.models['Model-1'].SurfaceToSurfaceContactStd(
        name='PayContactBottomAftLeft', createStepName='Initial', master=region1, 
        slave=region2, sliding=FINITE, thickness=ON, 
        interactionProperty='PayloadSlideyContactProp', adjustMethod=NONE, 
        initialClearance=OMIT, datumAxis=None, clearanceRegion=None)

    region1=a.instances['ARM-1'].surfaces['SPOON_BACK']
    region2=a.instances['Payload-1'].surfaces['BackBottomPayloadSticky2']
    mdb.models['Model-1'].SurfaceToSurfaceContactStd(
        name='PayContactBottomAftRight', createStepName='Initial', master=region1, 
        slave=region2, sliding=FINITE, thickness=ON, 
        interactionProperty='PayloadSlideyContactProp', adjustMethod=NONE, 
        initialClearance=OMIT, datumAxis=None, clearanceRegion=None)
    ...
    region1=a.instances['ARM-1'].surfaces['SPOON_FRONT']
    region2=a.instances['Payload-1'].surfaces['FrontBottomPayload']
    mdb.models['Model-1'].SurfaceToSurfaceContactStd(name='PayContactBottomForeward', 
        createStepName='Initial', master=region1, slave=region2, sliding=FINITE, 
        thickness=ON, interactionProperty='PayloadSlideyContactProp', 
        adjustMethod=NONE, initialClearance=OMIT, datumAxis=None, 
        clearanceRegion=None)
        
    #payload end surfaces
    region1=a.instances['ARM-1'].surfaces['SPOON_BACK']
    region2=a.instances['Payload-1'].surfaces['BackPayloadSticky1']
    mdb.models['Model-1'].SurfaceToSurfaceContactStd(name='PayContactEndAftLeft', 
        createStepName='Initial', master=region1, slave=region2, sliding=FINITE, 
        thickness=ON, interactionProperty='PayloadSlideyContactProp', 
        adjustMethod=NONE, initialClearance=OMIT, datumAxis=None, 
        clearanceRegion=None)
    ...
    region1=a.instances['ARM-1'].surfaces['SPOON_BACK']
    region2=a.instances['Payload-1'].surfaces['BackPayloadSticky2']
    mdb.models['Model-1'].SurfaceToSurfaceContactStd(name='PayContactEndAftRight', 
        createStepName='Initial', master=region1, slave=region2, sliding=FINITE, 
        thickness=ON, interactionProperty='PayloadSlideyContactProp', 
        adjustMethod=NONE, initialClearance=OMIT, datumAxis=None, 
        clearanceRegion=None)
    ...
    region1=a.instances['ARM-1'].surfaces['SPOON_FRONT']
    region2=a.instances['Payload-1'].surfaces['FrontPayload']
    mdb.models['Model-1'].SurfaceToSurfaceContactStd(name='PayContactEndForeward', 
        createStepName='Initial', master=region1, slave=region2, sliding=FINITE, 
        thickness=ON, interactionProperty='PayloadSlideyContactProp', 
        adjustMethod=NONE, initialClearance=OMIT, datumAxis=None, 
        clearanceRegion=None)
